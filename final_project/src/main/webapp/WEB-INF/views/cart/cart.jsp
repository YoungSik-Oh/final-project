...
<div class="container" ng-controller="one">
	<div>
		<h1 style="margin-top : 30px; margin-bottom : 30px;">장바구니</h1>
	</div>
	...
	<table class="table table-striped table-sm">
		...
		<c:forEach var="clists" items="${clist}">
			<tr>
				...
				<td>
					<a href="javascript:deleteConfirm(${clists.pNo });" class="text-danger">삭제</a>
				</td>
				<td>
	...
	<p style="margin-top : 20px; margin-bottom : 20px;" id="asdf">총 주문금액 : <c:out value="${total}"/></p>
	<hr>
	<div class="txtBox" style="margin-bottom : 30px; margin-top : 30px;">
		<ul>
