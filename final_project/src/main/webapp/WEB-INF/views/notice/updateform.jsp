...
<script>
	...
	function showHTML() {
		var sHTML = oEditors.getById["nContent"].getIR();
		alert(sHTML);
	}
		
	function submitContents(elClickedObj) {
		oEditors.getById["nContent"].exec("UPDATE_CONTENTS_FIELD", []);	// 에디터의 내용이 textarea에 적용됩니다.
	...
	function setDefaultFont() {
		var sDefaultFont = '궁서';
		var nFontSize = 24;
		oEditors.getById["nContent"].setDefaultFont(sDefaultFont, nFontSize);
	}
</script>
</body>
</html>