...
<body>
	<div class="container">
		...
		<div class="page-display">
		  ...
		  <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">끼이이이이이잉이이이이이이이이</div>
		  <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">콰아아아아아앙!!!!!!!!!!!!</div>
		</div>
	</div>
<script>
	//탈퇴 아이콘 클릭 시 회원 삭제
